    ...
    <div class="card-header">
        <div class="row flex-between-end">
            <div class="col-auto align-self-center">
                <h5 class="mb-0" data-anchor="data-anchor" id="example">Create New Sub Category</h5>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-floating mb-3">
                        <input class="form-control" type="text" id="name" placeholder="Sub Category Name" name="name" />
                    ...
                    <div class="card shadow-md">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <h5 class="card-title mb-0">Sub Category Image</h5>
                            ...
                            <div class="border border-dashed rounded d-flex align-items-center justify-content-center p-3"
                                ...
                                <div id="image-message" class="text-center text-muted">
                                    ...
                                    <p class="mt-2 small">Upload Sub Category Image</p>
                                </div>
                            </div>
