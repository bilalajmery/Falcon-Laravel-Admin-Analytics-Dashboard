        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="col-md-4 d-flex justify-content-end align-items-center">
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="trashRole" id="trashRole" value="1">
                    <label class="form-check-label" for="trashRole">Show Only Trashed Roles</label>
                </div>
            </div>
        </div>
    ...
    function getTableData(page = 1, perPage = 10) {
        ...
        $.ajax({
            ...
            data: {
                page: page,
                per_page: perPage,
                trashRole: $('#trashRole').is(':checked') ? 1 : 0,
            },
            beforeSend: function() {
                $tbody.html(`
                    <tr>
