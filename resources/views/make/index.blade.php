    ...
    <div class="card-header">
        <div class="row flex-between-end">
            <div class="col-auto align-self-center">
                <h5 class="mb-0">Make Management</h5>
            </div>
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="col-md-4 d-flex justify-content-end align-items-center">
                <div class="form-check">
                    ...
                    <label class="form-check-label" for="trashCategory">Show Only Trashed Makes</label>
                </div>
            </div>
        </div>
        ...
        <div class="table-responsive scrollbar">
            <table class="table table-striped table-bordered overflow-hidden" id="categoryTable">
                <thead>
                    <tr>
                        <th>#</th>
                        <th class="text-nowrap">Make Name</th>
                        <th>Status</th>
...
<script>
    function getTableData(page = 1, perPage = 10) {
        ...
        $.ajax({
            ...
            error: function(xhr) {
                const errorMessage = xhr.responseJSON?.message || 'Failed to load makes.';
