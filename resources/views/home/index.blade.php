        ...
        <div class="card overflow-hidden" style="min-width: 12rem">
            ...
            <div class="card-body position-relative">
                ...
                <div class="display-4 fs-5 mb-2 fw-normal font-sans-serif text-warning"
                    data-countup="{&quot;endValue&quot;:58.386,&quot;decimalPlaces&quot;:2,&quot;suffix&quot;:&quot;k&quot;}">58.39k</div><a
                    class="fw-semi-bold fs-10 text-nowrap" href="app/e-commerce/customers.html">See all<svg
                        class="svg-inline--fa fa-angle-right fa-w-8 ms-1" data-fa-transform="down-1" aria-hidden="true" focusable="false"
                        data-prefix="fas" data-icon="angle-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512"
        ...
        <div class="card overflow-hidden" style="min-width: 12rem">
            ...
            <div class="card-body position-relative">
                ...
                <div class="display-4 fs-5 mb-2 fw-normal font-sans-serif text-info"
                    data-countup="{&quot;endValue&quot;:23.434,&quot;decimalPlaces&quot;:2,&quot;suffix&quot;:&quot;k&quot;}">23.43k</div><a
                    class="fw-semi-bold fs-10 text-nowrap" href="app/e-commerce/orders/order-list.html">All orders<svg
                        class="svg-inline--fa fa-angle-right fa-w-8 ms-1" data-fa-transform="down-1" aria-hidden="true" focusable="false"
                        data-prefix="fas" data-icon="angle-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512"
                        data-fa-i2svg="" style="transform-origin: 0.25em 0.5625em;">
                        <g transform="translate(128 256)">
        ...
        <div class="card overflow-hidden" style="min-width: 12rem">
            ...
            <div class="card-body position-relative">
                ...
                <div class="display-4 fs-5 mb-2 fw-normal font-sans-serif"
                    data-countup="{&quot;endValue&quot;:43594,&quot;prefix&quot;:&quot;$&quot;}">$43,594</div><a
                    class="fw-semi-bold fs-10 text-nowrap" href="index.html">Statistics<svg class="svg-inline--fa fa-angle-right fa-w-8 ms-1"
                        data-fa-transform="down-1" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="angle-right" role="img"
                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512" data-fa-i2svg="" style="transform-origin: 0.25em 0.5625em;">
                        <g transform="translate(128 256)">
                            <g transform="translate(0, 32)  scale(1, 1)  rotate(0 0 0)">
                                <path fill="currentColor"
                                    d="M224.3 273l-136 136c-9.4 9.4-24.6 9.4-33.9 0l-22.6-22.6c-9.4-9.4-9.4-24.6 0-33.9l96.4-96.4-96.4-96.4c-9.4-9.4-9.4-24.6 0-33.9L54.3 103c9.4-9.4 24.6-9.4 33.9 0l136 136c9.5 9.4 9.5 24.6.1 34z"
                ...
                <div class="row h-100 justify-content-between g-0">
                    <div class="col-5 col-sm-6 col-xxl pe-2">
                        ...
                        <div class="fs-11 mt-3">
                            ...
                            <div class="d-flex flex-between-center mb-1">
                                <div class="d-flex align-items-center"><span class="dot bg-info"></span><span class="fw-semi-bold">Huawei</span>
                                </div>
                                <div class="d-xxl-none">29%</div>
                            </div>
                            <div class="d-flex flex-between-center mb-1">
                                <div class="d-flex align-items-center"><span class="dot bg-300"></span><span class="fw-semi-bold">Apple</span>
                                </div>
...
<script>
    ...
    var weeklySalesInit = function weeklySalesInit() {
        ...
        if ($echartBarWeeklySales) {
            ...
            var data = [120, 200, 150, 80, 70, 110, 70];
    ...
    var totalSalesEcommerce = function totalSalesEcommerce() {
        ...
        function getFormatter(params) {
            return params.map(function(_ref19) {
                ...
                return "\n          <span class= \"fas fa-circle\" style=\"color: ".concat(borderColor,
                    "\"></span>\n          <span class='text-600'>").concat(seriesName === 'lastMonth' ? 'Last Month' :
        ...
        if ($echartsLineTotalSalesEcomm) {
            ...
            var getDefaultOptions = function getDefaultOptions() {
                return {
                    ...
                    xAxis: {
                        type: 'category',
                        data: ['2019-01-05', '2019-01-06', '2019-01-07', '2019-01-08', '2019-01-09', '2019-01-10', '2019-01-11', '2019-01-12',
