...
<script>
    function getTableData(page = 1, perPage = 10) {
        const thCount = $('#adminTable thead tr th').length;
        ...
        $.ajax({
            ...
            data: {
                ...
                page: page,
                per_page: perPage,
                trashAdmin: $('#trashAdmin').is(':checked') ? 1 : 0,
            },
            beforeSend: function() {
                $tbody.html(`
                    <tr>
            ...
            error: function(xhr) {
                const errorMessage = xhr.responseJSON?.message || 'Failed to load admins.';
