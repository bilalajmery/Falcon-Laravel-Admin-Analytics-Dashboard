    ...
    <div class="card-header">
        <div class="row flex-between-end">
            <div class="col-auto align-self-center">
                <h5 class="mb-0" data-anchor="data-anchor" id="example">Edit Admin</h5>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-floating mb-3">
                        <input class="form-control" type="text" id="name" placeholder="Jhon" name="name" value="{{ $admin->name }}" />
                ...
                <div class="col-md-6">
                    <div class="form-floating mb-3">
                        <input class="form-control" type="email" placeholder="name@example.com" name="email" value="{{ $admin->email }}" />
                    ...
                    <div class="card shadow-sm">
                        <div class="card-body">
                            ...
                            <div class="border border-dashed rounded d-flex align-items-center justify-content-center p-3"
                                ...
                                <img id="image-preview" class="{{ $admin->profile ? '' : 'd-none' }}"
                                    style="width: 100%; height: 100%; object-fit: contain;" alt="Brand Preview"
                                    src="{{ $admin->profile ? $admin->profile : '' }}" />
                                <div id="image-message" class="text-center text-muted {{ $admin->profile ? 'd-none' : '' }}">
...
<script>
    function submitForm(event) {
        ...
        $.ajax({
                method: 'POST',
                url: '{{ route('admin.update', $admin->uid) }}',
                data: formData,
                processData: false,
                contentType: false,
                headers: {
