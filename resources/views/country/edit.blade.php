    ...
    <div class="card-header">
        <div class="row flex-between-end">
            <div class="col-auto align-self-center">
                <h5 class="mb-0" data-anchor="data-anchor" id="example">Edit Country</h5>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="form-floating mb-3">
                        <input class="form-control" type="text" id="name" placeholder="Country Name"
                ...
                <div class="col-md-4">
                    <div class="form-floating mb-3">
                        <input class="form-control" type="text" id="code" placeholder="Country Code"
...
<script>
    function submitForm(event) {
        ...
        $.ajax({
                method: 'POST',
                url: '{{ route('country.update', $country->uid) }}',
                data: formData,
                processData: false,
                contentType: false,
                headers: {
