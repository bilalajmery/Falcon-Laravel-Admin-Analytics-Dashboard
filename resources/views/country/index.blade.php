        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="col-md-4 d-flex justify-content-end align-items-center">
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="trashCountry" id="trashCountry"
                        value="1">
                    <label class="form-check-label" for="trashCountry">Show Only Trashed Countries</label>
                </div>
            </div>
        </div>

        <div class="table-responsive scrollbar">
            <table class="table table-striped table-bordered overflow-hidden" id="countryTable">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Name</th>
...
<script>
    function getTableData(page = 1, perPage = 10) {
        const thCount = $('#countryTable thead tr th').length;
        ...
        $.ajax({
            ...
            data: {
                page: page,
                per_page: perPage,
                trashCountry: $('#trashCountry').is(':checked') ? 1 : 0,
                search: $('#search').val(),
            },
            beforeSend: function() {
                $tbody.html(`
            ...
            error: function(xhr) {
                const errorMessage = xhr.responseJSON?.message || 'Failed to load countries.';
    ...
    $(document).ready(function() {
        ...
        $('#trashCountry').on('change', function() {
            getTableData();
        });
    });
</script>
