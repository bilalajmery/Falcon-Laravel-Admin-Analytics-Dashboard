...
<div class="row mb-2">
    @foreach (['Total' => 'warning', 'Trash' => 'danger'] as $label => $color)
                    ...
                    <div class="row flex-between-center">
                        <div class="col d-md-flex d-lg-block flex-between-center">
                            ...
                            <span class="badge rounded-pill badge-subtle-{{ $color }}">
                                <i class="fas {{ $label === 'Trash' ? 'fa-trash-alt' : 'fa-layer-group' }}"></i>
                            </span>
                        </div>
                        <div class="col-auto">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div class="col-md-4">
                <div class="form-floating mb-3">
                    <select class="form-select" id="countryId" name="countryId" aria-label="Floating label select example" onchange="getState()">
                    </select>
            ...
            <div class="col-md-4 px-3">
                <div class="form-floating mb-3">
                    <select class="form-select" id="stateId" name="stateId" aria-label="Floating label select example" disabled>
                        <option value="">First Select Country</option>
                    </select>
                    <label for="stateId">Parent State</label>
                </div>
            </div>
            ...
            <div class="col-md-4 d-flex justify-content-end align-items-center">
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="trashCity" id="trashCity" value="1">
                    <label class="form-check-label" for="trashCity">Show Only Trashed Cities</label>
                </div>
            </div>
        </div>

        <div class="table-responsive scrollbar">
            <table class="table table-striped table-bordered overflow-hidden" id="cityTable">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Name</th>
...
<script>
    ...
    function getTableData(page = 1, perPage = 10) {
        const thCount = $('#cityTable thead tr th').length;
        ...
        $.ajax({
            ...
            data: {
                page: page,
                per_page: perPage,
                trashCity: $('#trashCity').is(':checked') ? 1 : 0,
                search: $('#search').val(),
                stateId: $('#stateId').val(),
            ...
            error: function(xhr) {
                const errorMessage = xhr.responseJSON?.message || 'Failed to load cities.';
    ...
    $(document).ready(function() {
        ...
        $('#trashCity, #countryId, #stateId').on('change', function() {
            getTableData();
        });
    });
</script>
