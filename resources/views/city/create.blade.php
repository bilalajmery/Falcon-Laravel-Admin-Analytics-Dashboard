            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-floating mb-3">
                        <select class="form-control" id="countryId" name="countryId" onchange="getState()" required> </select>
                ...
                <div class="col-12">
                    <div class="form-floating mb-3">
                        <input class="form-control" type="text" id="name" placeholder="City Name"
                            name="name" />
