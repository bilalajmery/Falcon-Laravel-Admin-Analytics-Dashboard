    ...
    <div class="card-header">
        <div class="row flex-between-end">
            <div class="col-auto align-self-center">
                <h5 class="mb-0" data-anchor="data-anchor" id="example">Edit City</h5>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-floating mb-3">
                        <select class="form-control" id="countryId" name="countryId" onchange="getState()" required>
                        </select>
                ...
                <div class="col-12">
                    <div class="form-floating mb-3">
                        <input class="form-control" type="text" id="name" placeholder="City Name" name="name"
                            value="{{ $city->name }}" />
...
<script>
    ...
    getState('{{ $city->countryId }}', '{{ $city->stateId }}');
    ...
    function submitForm(event) {
        ...
        $.ajax({
                method: 'POST',
                url: '{{ route('city.update', $city->uid) }}',
                data: formData,
                processData: false,
                contentType: false,
                headers: {
