...
<div class="card mb-3">
    ...
    <div class="card-body bg-body-tertiary">
        ...
        <div class="table-responsive scrollbar">
            <table class="table table-striped table-bordered overflow-hidden" id="modelTable">
                <thead>
                    <tr>
                        <th>#</th>
...
<script>
    ...
    function getTableData(page = 1, perPage = 10) {
        const thCount = $('#modelTable thead tr th').length;
        ...
        $.ajax({
            ...
            error: function(xhr) {
                const errorMessage = xhr.responseJSON?.message || 'Failed to load Models.';
