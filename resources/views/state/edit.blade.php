    ...
    <div class="card-header">
        <div class="row flex-between-end">
            <div class="col-auto align-self-center">
                <h5 class="mb-0" data-anchor="data-anchor" id="example">Edit State</h5>
            </div>
        </div>
    </div>
    ...
    <div class="card-body bg-body-tertiary">
        <form onsubmit="submitForm(event)">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="form-floating mb-3">
                        <input class="form-control" type="text" id="name" placeholder="State Name" name="name"
                            value="{{ $state->name }}" />
                ...
                <div class="col-md-4">
                    <div class="form-floating mb-3">
                        <input class="form-control" type="text" id="code" placeholder="State Code" name="code"
                            value="{{ $state->code }}" />
...
<script>
    ...
    function submitForm(event) {
        ...
        $.ajax({
            method: 'POST',
            url: '{{ route('state.update', $state->uid) }}',
            data: formData,
            processData: false,
            contentType: false,
            headers: {
