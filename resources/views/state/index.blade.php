        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div class="col-md-4">
                <div class="form-floating mb-3">
                    <select class="form-select" id="countryId" name="countryId" aria-label="Floating label select example">
                    </select>
            ...
            <div class="col-md-4 d-flex justify-content-end align-items-center">
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="trashState" id="trashState" value="1">
                    <label class="form-check-label" for="trashState">Show Only Trashed States</label>
                </div>
            </div>
        </div>

        <div class="table-responsive scrollbar">
            <table class="table table-striped table-bordered overflow-hidden" id="stateTable">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Name</th>
...
<script>
    ...
    function getTableData(page = 1, perPage = 10) {
        const thCount = $('#stateTable thead tr th').length;
        ...
        $.ajax({
            ...
            data: {
                page: page,
                per_page: perPage,
                trashState: $('#trashState').is(':checked') ? 1 : 0,
                search: $('#search').val(),
            ...
            error: function (xhr) {
                const errorMessage = xhr.responseJSON?.message || 'Failed to load states.';
    ...
    $(document).ready(function () {
        ...
        $('#trashState, #countryId').on('change', function () {
            getTableData();
        });
    });
</script>
